...
class TestMSSW(TestCase):
    def test_ptg_for_all(self):
        ...
        ptg = mssw.mssw_preprocessing.ptg_for_all(reference_data)
    ...
    def test_information_utilities_for_all(self):
        ...
        inf_util = mssw.mssw_preprocessing.information_utilities_for_all(ptgs)
    ...
    def test_attribute_weights_for_all(self):
        ...
        attribute_weights = mssw.mssw_preprocessing.attribute_weights_for_all(information_utilities)
    ...
    def test_get_attribute_weights_from(self):
        reference_data = np.array([[3, 7], [3, 6]])
        attribute_weights = mssw.mssw_preprocessing.get_attribute_weights_from(reference_data)
    ...
    def test_transform_data_by_attribute_weights(self):
        ...
        weighted_data = mssw.mssw_preprocessing.transform_data_by_attribute_weights(original_data, attribute_weights)
    ...
    def test_transform_batches_by_attribute_weights(self):
        ...
        weighted_batches = mssw.mssw_preprocessing.transform_batches_by_attribute_weights(original_batches, dummy_weights)
